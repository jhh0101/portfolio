    ...
    public SecurityFilterChain filterChain(HttpSecurity http) {
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/user/*/suspend").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/user/suspension-status/*").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/user/list").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PATCH, "/api/user/*/approve").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PATCH, "/api/user/*/reject").hasRole("ADMIN")
