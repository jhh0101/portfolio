...
public class ProductController {
    ...
    public ResponseEntity<ApiResponse<ProductImageResponse>> uploadImages(@PathVariable("id") Long productId, // 경로에서 상품 ID 추출
                                                                         @RequestPart("files") List<MultipartFile> files){
        ProductImageResponse response = productService.uploadImages(productId, files);
